...
const Basket = sequelize.define('basket', {
    id: {type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
    user_id: {type: DataTypes.STRING, defaultValue: "USER"}
});
...
Type.belongsToMany(Brand, {through: TypeBrand}); // Так как связь многие ко многим слздается промежуточная таблица
